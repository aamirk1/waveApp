...
if(isset($_GET['id']) && $_GET['id']!=''){
	...
	$res=mysqli_query($con,"select * from banking where id='$id'");
...
if(isset($_POST['submit'])){
	$holder_name=get_safe_value($con,$_POST['holder_name']);
	$acount_number=get_safe_value($con,$_POST['acount_number']);
	$bank_name = get_safe_value($con,$_POST['bank_name']);
	$confirm_account=get_safe_value($con,$_POST['confirm_account']);
	$ifsc_code=get_safe_value($con,$_POST['ifsc_code']);	

	$res=mysqli_query($con,"select * from banking where acount_number='$acount_number'");
	$check=mysqli_num_rows($res);
	if($check>0){
		if(isset($_GET['id']) && $_GET['id']!=''){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){		
			$update_sql="update banking set holder_name='$holder_name', bank_name='$bank_name',acount_number='$acount_number',confirm_account='$confirm_account',ifsc_code='$ifsc_code' where id='$id'";
			
			mysqli_query($con,$update_sql);
		}else{
			
			mysqli_query($con,"insert into banking(holder_name,acount_number,bank_name,confirm_account,ifsc_code) values('$holder_name','$acount_number','$bank_name','$confirm_account','$ifsc_code')");
		}
		redirect('bank.php');
	}
  ...
  <div class="container-fluid">
    <div class="row">
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="acount_number" required/>
                  </div>
				          <div class="col">
                    <label>Confirm Account Number</label>
                    <input type="text" class="form-control" name="confirm_account" required/>
                  </div>
                  <div class="col">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Bank Details &nbsp;&nbsp;<span><a href="all_bank.php">View All</a> </span></h3>
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-white text-nowrap">
              ...
              <tbody>
                ...
                $ress=mysqli_query($con,"SELECT * FROM banking ORDER BY id DESC LIMIT 4");
                $i=1;
